...
def densityplot():
    ...
    def Speed_parameters(speed):
        ...
        fig.update_layout(mapbox_style="open-street-map", mapbox_center_lat=14.5794, mapbox_center_lon=121.0359, zoom=14)
        fig.update_layout(margin={"r":0,"t":0,"l":0,"b":0})
        fig.show()
    ...
    def Altitude_parameters(altitude):
        ...
        fig.update_layout(mapbox_style="open-street-map", mapbox_center_lat=14.5794, mapbox_center_lon=121.0359)
        fig.update_layout(margin={"r":0,"t":0,"l":0,"b":0})
        fig.show()
    ...
    def plots(plottype):
        ...
        if plot_type_widget.value == "Scatter Plot" :
            display(plotout,plotui,plotout_1,plotui_1, plotout_2,plotui_2)

        elif plot_type_widget.value == "Heat Map Grids Plot" :
            plotui_1.close()
            plotout_1.close()
            display(plottype)
